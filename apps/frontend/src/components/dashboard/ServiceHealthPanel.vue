...
function healthColor(label: string) { return statusColors[label.trim().toLowerCase().replace(/[\s_-]+/g, "")] ?? "#6b7280"; }
...
<style scoped>
.service-health-panel { display: grid; gap: 10px; min-width: 0; background: transparent; container: service-health / inline-size; }
...
@container service-health (max-width: 520px) {
